        ...
        <div className="flex flex-col p-4 space-y-8 items-center justify-center">
          ...
          <div className="flex py-1 md:ml-[-6rem] mb-8 space-x-6 sm:space-x-12 justify-center  md:mt-2 mt-10 sm:ml-[-12rem]">
            <a
              ...
              className="px-8 flex gap-2 lg:h-18 md:text-3xl md:w-75 md:h-25  items-center w-full sm:w-auto py-4 animate-pulse border-1 text-sm font-bold shadow-2xl rounded-2xl border-neutral-900 text-neutral-900 dark:border-1 cursor-pointer dark:border-neutral-100 dark:text-neutral-100 hover:bg-red-600 hover:text-white hover:border-transparent transition-colors duration-500"
            >
